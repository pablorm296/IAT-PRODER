...
function showInstructions() {
    ...
    switch (__stage) {
        ...
        case 2:
            ...
            assignLabelsAndText("word", "<p>En este bloque tendrás que categorizar palabras.</p><p><b>Palabras buenas:</b> competente, trabajador, constante, cariñoso, tierno, amoroso, dulce</p><p><b>Palabras malas:</b> agresivo, rudo, problemático, violento, mediocre, conformista, mentiroso, corrupto.</p><p>Recuerda que cuando una palabra aparezca, toca el rectángulo de color verde que contenga la categoría a la que pertenece.</p>", false);
            break;
        case 3:
            //Definir tamaño del placeholder
            // Set blank div class
        ...
        case 5:
            ...
            $("#blank").removeClass("blank_bigger");
            $("#blank").addClass("blank_medium");
            assignLabelsAndText("img", "<p>Atención: observa la parte dearriba y nota que sólo hay dos categoría y han cambiado de posición. Practica en esta nueva configuración.</p><p>Recuerda que cuando una imagen aparezca, toca el rectángulo de color verde que contenga la categoría a la que pertenece.</p>", true);
            break;
        case 6:
            //Definir tamaño del placeholder
            // Set blank div class
